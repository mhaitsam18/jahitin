...
class Pembayaran_admin extends CI_Controller {
    ...
    public function index()
	{
		...
		$this->load->view('Taylor/Pembayaran_admin', $data);
    ...
    public function edit($id_pembayaran)
	{
		...
		$this->load->view('template_taylor/Header');
		$this->load->view('template_taylor/Sidebar');
		$this->load->view('Taylor/Edit_pembayaran', $data);
        $this->load->view('template_taylor/Footer');
	}
    ...
    public function update()
	{
        ...
        redirect('Taylor/Pembayaran_admin/index');
	}
    ...
    public function print_pembayaran()
	{
		...
		$this->load->view('Taylor/Print_pembayaran', $data);
	}
