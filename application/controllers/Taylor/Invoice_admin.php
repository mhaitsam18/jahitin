...
class Invoice_admin extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('Taylor/Invoice_admin', $data);
	...
	public function detail($id_invoice)
	{
		...
		$this->load->view('template_taylor/Header');
		$this->load->view('template_taylor/Sidebar');
		$this->load->view('Taylor/Detail_invoice', $data);
        $this->load->view('template_taylor/Footer');
	}
	...
	public function edit($id_invoice)
	{
		...
		$this->load->view('template_taylor/Header');
		$this->load->view('template_taylor/Sidebar');
		$this->load->view('Taylor/edit_invoice', $data);
        $this->load->view('template_taylor/Footer');
	}
    ...
    public function update()
	{
        ...
        redirect('Taylor/Invoice_admin/index');
	}
	...
	public function print()
	{
		...
		$this->load->view('Taylor/Print_invoice', $data);
	}
}