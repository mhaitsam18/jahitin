...
class Pembayaran_admin extends CI_Controller {
    ...
    public function index()
	{
		...
		$this->load->view('Desainer/Pembayaran_admin', $data);
    ...
    public function edit($id_pembayaran)
	{
		...
		$this->load->view('template_Desainer/Header');
		$this->load->view('template_Desainer/Sidebar');
		$this->load->view('Desainer/Edit_pembayaran', $data);
        $this->load->view('template_Desainer/Footer');
	}
    ...
    public function update()
	{
        ...
        redirect('Desainer/Pembayaran_admin/index');
	}
    ...
    public function print_pembayaran()
	{
		...
		$this->load->view('Desainer/Print_pembayaran', $data);
	}
