...
class Invoice_admin extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('Desainer/Invoice_admin', $data);
	...
	public function detail($id_invoice)
	{
		...
		$this->load->view('template_Desainer/Header');
		$this->load->view('template_Desainer/Sidebar');
		$this->load->view('Desainer/Detail_invoice', $data);
        $this->load->view('template_Desainer/Footer');
	}
	...
	public function edit($id_invoice)
	{
		...
		$this->load->view('template_Desainer/Header');
		$this->load->view('template_Desainer/Sidebar');
		$this->load->view('Desainer/edit_invoice', $data);
        $this->load->view('template_Desainer/Footer');
	}
    ...
    public function update()
	{
        ...
        redirect('Desainer/Invoice_admin/index');
	}
	...
	public function print()
	{
		...
		$this->load->view('Desainer/Print_invoice', $data);
	}
}