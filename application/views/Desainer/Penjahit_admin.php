                            ...
                            <table class="table">
                                ...
                                foreach ($penjahit as $row): ?>
                                    <tr>
                                        ...
                                        <td><?= anchor('admin/Penjahit_admin/hapus/' .$row->id_user, 
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?= base_url().'penjahit/Registrasi_penjahit'?>" method="post" enctype="multipart/form-data">
